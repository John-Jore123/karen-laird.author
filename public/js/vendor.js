...
function darkMode() {
  darkObj.icon.text(function (i, v) {
    return v === 'brightness_5' ? 'brightness_2' : 'brightness_5';
  });
...
headerObj.hamburger.addEventListener('click', function () {
...
$(function () {
  ...
  iti.getNumber(); // $("#contactMail").on('submit', function(e) { 
  //     e.preventDefault()
...
function validateEmail() {
  ...
  $('#emailJS').keyup(function () {
    ...
    var x = mail.trim();
    var _char3 = x.replace(/\s+/gi, '').length;
...
function validatePhone() {
  $('#phoneJS').on("keyup", function () {
    ...
    var regEx = /^([\d\s\-\+\(\)]*)$/;
    var x = mobile.trim();
    var _char4 = x.replace(/\s+/gi, '').length;
