...
<input {{ $attributes->merge(['class' => 'peer block w-full appearance-none border-0 border-b-2 border-white bg-transparent py-2.5 px-0 text-sm text-white focus:border-minsk-900 dark:focus:border-white focus:outline-none focus:ring-0']) }} placeholder=" " />
