            ...
            <form action="@route('send.email')" method="POST" class="mx-4" autocomplete="off" id="email_author_form">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div class="relative z-0 col-span-1">
                        <x-form.input type="text" name="name" id="nameJS" icon="person" value="{{ old('name') }}" {{ $attributes->class([ 'dark:border-dark-600' ]) }}>Your name</x-form.input>
                    ...
                    <div class="relative z-0 col-span-1">
                        <x-form.input type="text" name="phone" id="phoneJS" icon="phone_android" value="{{ old('phone') }}" {{ $attributes->class([ 'dark:border-dark-600' ]) }}>Your phone</x-form.input>
                    ...
                    <div class="relative z-0 col-span-2">
                        <x-form.input type="email" name="email" id="emailJS" icon="email" {{ $attributes->class([ 'dark:border-dark-600' ]) }}>Your email</x-form.input>
                    ...
                    <div class="relative z-0 col-span-2">
                        <x-form.textarea name="message" id="messageJS" icon="edit" {{ $attributes->class([ 'dark:border-dark-600' ]) }}>Message</x-form.textarea>
